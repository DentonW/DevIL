...
ILboolean ILAPIENTRY ilLoadData(ILstring FileName, ILuint Width, ILuint Height, ILuint Depth, ILubyte Bpp)
{
	ILHANDLE	RawFile;
...
ILboolean ILAPIENTRY ilSaveData(ILstring FileName)
{
	ILHANDLE DataFile;
